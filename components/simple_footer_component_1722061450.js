...
*/
Vue.component("simple_footer_component_1722061450", {
    template: `
            ...
            <div id="footer-container" class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                ...
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Stay ahead of the curve with Discover. Our app keeps you informed about the newest and most innovative products on the market across all categories. Never miss out on the next big thing again!
                    </div>
                </div>
            </div>
        </footer> 
