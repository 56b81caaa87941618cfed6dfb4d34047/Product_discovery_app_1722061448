...
*/
Vue.component("simple_hero_component_1722061450", {
    template: `
        <div>
            <nav class="bg-white shadow-md dark:bg-gray-800">
                <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div class="flex space-x-4">
                        <a href="#" class="text-gray-700 hover:text-blue-700 dark:text-gray-300 dark:hover:text-white">Home</a>
                        <a href="#" class="text-gray-700 hover:text-blue-700 dark:text-gray-300 dark:hover:text-white">About</a>
                        <a href="#" class="text-gray-700 hover:text-blue-700 dark:text-gray-300 dark:hover:text-white">Contact Us</a>
                    </div>
                </div>
            </nav>
            <nav class="bg-white shadow-md dark:bg-gray-800">
